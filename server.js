...
// Sin logo propio → usa el fantasmita Ghosty por default (no un emoji).
const DEFAULT_LOGO =
  "https://raw.githubusercontent.com/blissito/ghosty-launch/main/assets/ghosty.png";
const logo = process.env.APP_LOGO || DEFAULT_LOGO;
